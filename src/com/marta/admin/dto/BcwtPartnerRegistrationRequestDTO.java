...
public class BcwtPartnerRegistrationRequestDTO implements Serializable {
	...
	private String newStatusFlag ;
	
	public String getNewStatusFlag() {
		return newStatusFlag;
	}
	public void setNewStatusFlag(String newStatusFlag) {
		this.newStatusFlag = newStatusFlag;
	}
